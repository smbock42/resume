...
## Current state
User clarified ownership of a custom multi-tenant control plane and dynamic Envoy sidecars, with Enterprise API Platform access updates, traffic routing, ingress/egress filtering, and UI metrics. Resume now emphasizes the implementation instead of vendor research; production status is not asserted.
